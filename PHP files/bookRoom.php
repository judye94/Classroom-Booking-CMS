...
<html lang="en">
  <head>
    ...
    <title>Book Room | Dashboard </title>
  ...
  <body>
    ...
    <header id ="header">
      <div class="container">
        <div class="row">
            <div class="col-md-10">
              <h1><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Make Reservation</h1>
      </div>
      <div class="col-md-2">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3">
            ...
            <a href="bookRoom.php" class="list-group-item active main-color-bg"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Book Room</a>
          ...
          <div class="col-md-9">
            ...
            <div class="panel-heading main-color-bg">
              <h3 class="panel-title">Reserve Here</h3>
            </div>
            <div class="panel-body">
                    <h1>All booking information will be placed in here to allow users to reserve an available room</h1>

                    <h2> A calender can be placed in here to allow users to select a date and view available rooms for that date </h2>
             </div>
            </div>
